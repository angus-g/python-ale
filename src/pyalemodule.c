...
extern bool init_mom_shelf(void*, PyObject*);
extern bool calc_mom_sfc_displacement(void*, PyObject*);
extern bool get_mom_thickness(void*, double*, int, int, int);
...
static PyObject *mom_init_shelf(PyObject *self, PyObject *args) {
  void *cs;
  PyObject *cs_ptr, *param_dict;
  int ok;

  ok = PyArg_ParseTuple(args, "O!O!", &PyCapsule_Type, &cs_ptr, &PyDict_Type, &param_dict);
  if (!ok)
    return NULL;
...
static PyObject *mom_displace_sfc(PyObject *self, PyObject *args) {
  void *cs;
  PyObject *cs_ptr, *param_dict;
  int ok;
...
static PyObject *pyale_get_thickness(PyObject *self, PyObject *args) {
  void *cs;
  PyObject *cs_ptr;
  int ok;
  int ni, nj, nk;
  ...
  ok = PyArg_ParseTuple(args, "O!", &PyCapsule_Type, &cs_ptr);
  if (!ok)
    return NULL;
...
static PyMethodDef PyaleMethods[] = {
  ...
  {"mom_init_shelf", mom_init_shelf, METH_VARARGS, "Query ice shelf information."},
  {"mom_displace_sfc", mom_displace_sfc, METH_VARARGS, "Calculate the surface displacement."},
  {"mom_get_thickness", pyale_get_thickness, METH_VARARGS, "Retrieve the current thickness array, h."},
